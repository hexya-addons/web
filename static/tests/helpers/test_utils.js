hexya.define('web.test_utils', function (require) {
"use strict";
...
return Promise.all([
    session.is_bound,
    ajax.loadXML('/static/web/src/xml/debug.xml', core.qweb),
    ajax.loadXML('/static/web/src/xml/dialog.xml', core.qweb),
    ajax.loadXML('/static/web/src/xml/translation_dialog.xml', core.qweb),
]).then(function () {
    setTimeout(function () {
