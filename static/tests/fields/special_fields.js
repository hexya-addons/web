hexya.define('web.special_fields_tests', function (require) {
"use strict";
    ...
    QUnit.test('report_layout widget in form view', async function (assert) {
        ...
        this.data['report.layout'] = {
            ...
            records: [{
                id: 1,
                view_id: 37,
                image: "/static/web/toto.png",
                pdf: "/static/web/toto.pdf",
            }, {
                id: 2,
                view_id: 41,
                image: "/static/web/tata.png",
                pdf: "/static/web/tata.pdf",
            }],
        };
