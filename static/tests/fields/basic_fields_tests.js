hexya.define('web.basic_fields_tests', function (require) {
"use strict";
    ...
    QUnit.test("pdf_viewer: basic rendering", async function (assert) {
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route.indexOf('/static/web/lib/pdfjs/web/viewer.html') !== -1) {
                    return Promise.resolve();
                }
                return this._super.apply(this, arguments);
            }
        ...
        assert.hasAttrValue(form.$('.o_field_widget iframe.o_pdfview_iframe'), 'data-src',
            '/static/web/lib/pdfjs/web/viewer.html?file=%2Fweb%2Fcontent%3Fmodel%3Dpartner%26field%3Ddocument%26id%3D1#page=1',
...
//    testUtils.dom.click(     list.$buttons.find('.o_list_button_save'));
    ...
    QUnit.module('FieldColor', {
        before: function () {
            return ajax.loadXML('/static/web/src/xml/colorpicker_dialog.xml', core.qweb);
        },
    });
