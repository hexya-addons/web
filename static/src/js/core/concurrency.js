hexya.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Hexya.
 *
 * The basic concurrency primitives in Hexya JS are the callback, and the
...
return {
    ...
    /**
     * A (Hexya) mutex is a primitive for serializing computations.  This is
