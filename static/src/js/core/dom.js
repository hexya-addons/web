hexya.define('web.dom_ready', function (require) {
'use strict';
...
hexya.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the hexya framework.  A common theme in these functions
...
var dom = {
    ...
    /**
     * Renders a button with standard hexya template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard hexya/BS template. This does not use any
