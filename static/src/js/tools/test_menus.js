(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = hexya.__DEBUG__.services['web.AbstractController'];
        var Discuss = hexya.__DEBUG__.services['mail.Discuss'];
        var WebClient = hexya.__DEBUG__.services["web.WebClient"];
    ...
    function _clickEverywhere(menu_id){
        ...
        testedApps = [];
        testedMenus = [];
        var isEnterprise = hexya.session_info.server_version_info[5] === 'e';
        // finding applications menus
        var $listOfAppMenuItems;
        if (isEnterprise) {
            console.log("Hexya flavor: Enterprise");
            ...
            console.log("Hexya flavor: Community");
            if (menu_id !== undefined) {
