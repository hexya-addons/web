hexya.define('web.basic_fields', function (require) {
"use strict";
...
var InputField = DebouncedField.extend({
     ...
     *
     * @param {HexyaEvent} event 'field_changed' event
     */
...
var FieldDateRange = InputField.extend({
    ...
    tagName: 'span',
    jsLibs: [
        '/static/web/lib/daterangepicker/daterangepicker.js',
        '/static/web/src/js/libs/daterangepicker.js',
    ],
    cssLibs: [
        '/static/web/lib/daterangepicker/daterangepicker.css',
    ],
    ...
    _applyChanges: function (ev, picker) {
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, Hexya will consider it as UTC. To fix this added browser
...
var FieldPdfViewer = FieldBinaryFile.extend({
    ...
    _getURI: function (fileURI) {
        ...
        var viewerURL = '/static/web/lib/pdfjs/web/viewer.html?file=';
...
var AceEditor = DebouncedField.extend({
    template: "AceEditor",
    jsLibs: [
        '/static/web/lib/ace/ace.js',
        [
            '/static/web/lib/ace/mode-python.js',
            '/static/web/lib/ace/mode-xml.js'
        ]
    ],
