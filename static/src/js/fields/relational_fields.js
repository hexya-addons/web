hexya.define('web.relational_fields', function (require) {
"use strict";
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {HexyaEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {HexyaEvent|MouseEvent} ev this event comes either from the 'Add
