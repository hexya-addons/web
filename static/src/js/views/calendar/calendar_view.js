hexya.define('web.CalendarView', function (require) {
"use strict";
...
var CalendarView = AbstractView.extend({
    ...
    icon: 'fa-calendar',
    jsLibs: ['/static/web/lib/fullcalendar/js/fullcalendar.js'],
    cssLibs: ['/static/web/lib/fullcalendar/css/fullcalendar.css'],
