hexya.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Hexya JS views are the
 ...
 * the word 'view' has historical significance in Hexya code, so we replaced the
