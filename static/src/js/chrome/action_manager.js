 ...
 * Its role is to makes sure that Hexya actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Hexya actions, given as an ID in
     ...
     * @private
     * @param {HexyaEvent} ev
     * @param {HexyaEvent} ev.data.controllerID
     */
