...
return AbstractWebClient.extend({
    ...
    bind_events: function () {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since hexya use hashtag
    ...
    load_menus: function () {
        return (hexya.loadMenusPromise || hexya.reloadMenus())
