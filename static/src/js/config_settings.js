hexya.define('base.settings', function (require) {
    "use strict";
    ...
    var BaseSettingRenderer = FormRenderer.extend({
        ...
        _getAppIconUrl: function (module) {
            return module === "general_settings" ? "/static/base/description/settings.png" : "/static/" + module + "/description/icon.png";
        },
        /**
         *
         * @private
    ...
    var BaseSettingView = FormView.extend({
        ...
        init: function () {
            if (config.device.isMobile) {
                this.jsLibs.push('/static/web/lib/jquery.touchSwipe/jquery.touchSwipe.js');
            }
            this._super.apply(this, arguments);
        },
    });
